		...
		public void TestMethod1()
		{
			...
			var a4=
				nilnul.num.real.matrix.bi_._AddX._Add_1isosize(
					nilnul.num.real.matrix_.sq.op_._PonentX._Ponent_0equilat_1unneg(a, 4)
					,
					nilnul.num.real.matrix_.sq.op_._PonentX._Ponent_0equilat_1unneg(b, 4)
				);

			var c4 =
			nilnul.num.real.matrix_.sq.op_._PonentX._Ponent_0equilat_1unneg(c, 4);

		...
		{
			{
				...
				nilnul.num.real.matrix.op_.dent_._EchelonX.EchelonForRank(ref m);
...

			{
				...
				num.real.matrix.op_.dent_.echelon_._VentX.Vent(ref m);
...

			{
				...
				//num.real.matrix.op_.indent_.echelon_._RegulateX.Regulate
					num.real.matrix.op_.dent_.echelon_._VentX.Vent
...

			{
				...
				num.real.matrix.op_.dent_.echelon_._VentX.Vent(ref m1);
